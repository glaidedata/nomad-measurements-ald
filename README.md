# nomad-measurements-ald

NOMAD plugin for Atomic Layer Deposition (ALD) data.
...
```sh
git clone https://github.com/abbasgholami71/nomad-measurements-ald.git
cd nomad-measurements-ald
